...
<div class="width-100 margin-top-50">
  <div class="container">
    ...
    <?php 
    include("./connect.php");
    $select_query = "Select * from product_table order by rand() limit 0,20 ";
    ...
    while($row=mysqli_fetch_assoc($result_query)){
      ...
      if($ori_product_price <= $dis_product_price){
        $product_discount=0;
      }
      else{
    ...
    echo "<h2 class='noproduct'>You have not Any Product</2>";
  }
    ?>
  </div>
  </div>  
...
<footer class="footer">
  ...
  <div class="content content1">
    <h2><u>Contact</u></h2>
    <p class="footer-data"><br>Contact:7240206069 <br><br>E-mail:baghelsatendra27@gmail.com</p>
  </div>
