...
<div class="width-100 margin-top-50">
  <div class="container">
    ...
    <?php 
    include("./connect.php");
    $select_query = "Select * from product_table where product_catagories='appliances'";
    ...
    echo "<h2 class='noproduct'>You have not Any Product For this Catagory</h2>";
  }
    ?>
